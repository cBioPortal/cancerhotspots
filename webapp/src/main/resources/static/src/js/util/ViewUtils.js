...
var ViewUtils = (function() {
    ...
    var _oncotree = {
        ...
        "headandneck": {"color": "DarkRed", "name": "Head and Neck"},
        "biliary_tract": {"color": "Green", "name": "Biliary Tract"},
        "biliarytract": {"color": "Green", "name": "Biliary Tract"},
        "pns": {"color": "Gray", "name": "Peripheral Nervous System"},
        "peripheralnervoussystem": {"color": "Gray", "name": "Peripheral Nervous System"},
        "adrenal_gland": {"color": "Purple", "name": "Adrenal Gland"},
        "adrenalgland": {"color": "Purple", "name": "Adrenal Gland"},
        "uterus": {"color": "PeachPuff", "name": "Uterus"},
        "uterine": {"color": "PeachPuff", "name": "Uterus"},
        ...
        "lymphoid": {"color": "LimeGreen", "name": "Lymph"},
        "brain": {"color": "Gray", "name": "CNS/Brain"},
        "cnsbrain": {"color": "Gray", "name": "CNS/Brain"},
        "bowel": {"color": "SaddleBrown", "name": "Bowel"},
        "ovary": {"color": "LightBlue", "name": "Ovary/Fallopian Tube"},
        "ovaryfallopiantube": {"color": "LightBlue", "name": "Ovary/Fallopian Tube"},
        ...
        "esophagusstomach": {"color": "LightSkyBlue", "name": "Esophagus/Stomach"},
        "ampulla_of_vater": {"color": "Purple", "name": "Ampulla of Vater"},
        "ampullaofvater": {"color": "Purple", "name": "Ampulla of Vater"},
        "kidney": {"color": "Orange", "name": "Kidney"},
        "vulva": {"color": "Purple", "name": "Vulva/Vagina"},
        "vulvavagina": {"color": "Purple", "name": "Vulva/Vagina"},
