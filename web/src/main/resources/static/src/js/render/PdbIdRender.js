 ...
 */
function PdbIdRender(options)
{
    var _defaultOpts = {
        templateId: "pdb_id_column",
        dataManager: false
    };
    ...
    function render(data, type)
    {
        ...
        else
        {
            ...
            return templateFn({pdbId: data.pdbId});
        }
    }
    ...
    function postRender(td, cellData, rowData, row, col)
    {
        ...
        pdbElem.on('click', function() {
            ...
            {
                // select the pdb!
                _options.dataManager.selectPdbChain(cellData.pdbId + ":" + cellData.chain);
            }
        });
    }
